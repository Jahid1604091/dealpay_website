...
export default function MFS() {
  ...
  const [selectedMfs, setSelectedMfs] = useState(null); // Initially null to handle the loading state
    ...
    <>
      ...
      <section className="max-w-[480px] my-30 mx-auto px-16">
        <form onSubmit={handleSubmit}>
                ...
                <ul>
                  ...
                  <li className="text-white flex justify-between items-center my-6">
                    ...
                    <input
                      type="number"
                      disabled
                      value={subscriptionInfo?.currentSubscription?.price}
          ...
          <div className="flex justify-around items-center my-30">
